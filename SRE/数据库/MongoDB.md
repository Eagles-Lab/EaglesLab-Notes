...
![img-MongoDB_Logos](MongoDB/MongoDB_Logos.png)
...
![img-MongoDB简介01](MongoDB/MongoDB简介01.png)

![img-MongoDB简介02](MongoDB/MongoDB简介02.png)
...
![img-MongoDB支持语言](MongoDB/MongoDB支持语言.png)

## MongoDB 与关系型数据库术语对比

![img-MongoDB对比关系型](MongoDB/MongoDB对比关系型.png)
...
![img-分片集群01](MongoDB/分片集群01.png)

## 分片集群架构目标

两个分片节点副本集（3+3）+ 一个配置节点副本集（3）+两个路由节点（2），共11个服务节点。

![img-分片集群架构](MongoDB/分片集群架构.png)
...
![img-哈希分片](MongoDB/哈希分片.png)

![img-范围分片](MongoDB/范围分片.png)
